    ...
    <section className="relative overflow-hidden bg-[#070b14]">
      ...
      <div className="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28 text-center">
        ...
        <a
          ...
          className="inline-flex items-center gap-3 bg-[#25D366] hover:bg-[#1fba59] text-white font-bold text-base sm:text-lg px-8 sm:px-10 py-4 sm:py-5 rounded-full transition-all hover:scale-105 shadow-xl shadow-green-500/20"
        >
