    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 text-center">
        ...
        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">
          Hemen İzlemeye Başlayn
        </h2>

        {/* Subtext */}
        <p className="text-gray-400 text-base sm:text-lg mb-8 max-w-xl mx-auto">
          WhatsApp üzerinden 7/24 ulaşn &mdash; annda aktivasyon.
        </p>
        ...
        <a
          ...
          className="inline-flex items-center gap-2.5 bg-[#25D366] hover:bg-[#1fba59] text-white font-semibold text-base sm:text-lg px-8 py-4 rounded-xl transition-all hover:scale-105 shadow-lg shadow-green-500/20"
        >
