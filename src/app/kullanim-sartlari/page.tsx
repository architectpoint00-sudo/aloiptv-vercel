...
export const metadata = buildMetadata({
  ...
  description:
    'AloIPTV kullanim sartlari ve kosullari. Hizmet kullanimi, odeme, iade ve hesap yonetimi hakkinda detayli bilgi.',
    ...
    <section className="bg-[#0a0a0f] min-h-screen py-16 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-gray-300 leading-relaxed mb-8">
          AloIPTV hizmetlerini kullanarak bu sartlari kabul etmis
          sayilirsiniz. Lutfen hizmetlerimizi kullanmadan once asagidaki
          kosullari dikkatlice okuyunuz.
        </p>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 text-center">
          <p className="text-gray-400 mb-4">
            Kullanim sartlari hakkinda sorulariniz icin bize ulasin
          </p>
          <a
