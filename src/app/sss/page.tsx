    ...
    <main>
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-12 sm:pt-12 sm:pb-16">
        ...
        <div className="text-center mb-12 sm:mb-16">
          <span className="inline-flex items-center gap-2 text-blue-400 text-xs font-bold uppercase tracking-widest bg-blue-500/[0.08] border border-blue-500/15 px-5 py-2 rounded-full mb-6">
            Destek Merkezi
          </span>
        ...
        <div className="text-center py-12 sm:py-16">
          <div className="glass-card rounded-2xl p-8 sm:p-12">
            ...
            <a
              ...
              className="inline-flex items-center gap-2.5 bg-[#25D366] hover:bg-[#1fba59] text-white font-bold text-base px-8 py-4 rounded-xl transition-all hover:scale-105 shadow-xl shadow-green-500/25 btn-shine"
            >
