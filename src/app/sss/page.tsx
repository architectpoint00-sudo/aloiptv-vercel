    ...
    <main>
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-12 sm:pt-12 sm:pb-16">
        ...
        <div className="text-center py-12 sm:py-16">
          <div className="bg-[#111827] border border-[#1e293b] rounded-2xl p-8 sm:p-12">
            ...
            <a
              ...
              className="inline-flex items-center gap-2.5 bg-[#25D366] hover:bg-[#1fba59] text-white font-bold text-base px-8 py-4 rounded-full transition-all hover:scale-105 shadow-lg shadow-green-500/20"
            >
