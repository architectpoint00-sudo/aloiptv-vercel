              ...
              >
                ...
                <div className="flex flex-wrap gap-2">
                  {group.channels.map((channel) => (
                    <span
                      key={channel}
                      className="inline-block bg-white/[0.04] text-gray-300 text-xs px-3 py-1.5 rounded-full border border-white/[0.04] hover:border-red-500/20 hover:text-white transition-colors"
                    >
                      {channel}
                    </span>
                  ))}
        ...
        <div className="text-center py-12 sm:py-16">
          <div className="glass-card rounded-2xl p-8 sm:p-12 max-w-3xl mx-auto">
            ...
            <a
              ...
              className="inline-flex items-center gap-2.5 bg-[#25D366] hover:bg-[#1fba59] text-white font-semibold text-base px-8 py-4 rounded-xl transition-all hover:scale-105 shadow-xl shadow-green-500/25 btn-shine"
            >
