...
export const metadata = buildMetadata({
  title: "Akilli TV'de IPTV Nasil Kurulur? -- 2026 Kurulum Rehberi",
      ...
      <div className="max-w-3xl mx-auto">
        <Breadcrumb
          items={[
            ...
            { label: "Akilli TV'de IPTV Nasil Kurulur?" },
          ]}
        />
        ...
        <div className="border-t border-gray-800 pt-8 mb-12">
          ...
          <div className="flex items-center gap-3">
            <a
              href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(post.title)}&url=${encodeURIComponent('https://aloiptv.net/blog/akilli-tvde-iptv-kurulumu/')}`}
              target="_blank"
            ...
            <a
              href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent('https://aloiptv.net/blog/akilli-tvde-iptv-kurulumu/')}`}
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 bg-white/5 hover:bg-white/10 text-gray-300 hover:text-white px-4 py-2 rounded-lg text-sm transition-colors"
            >
            ...
            <a
              href={`https://wa.me/?text=${encodeURIComponent(post.title + ' — https://aloiptv.net/blog/akilli-tvde-iptv-kurulumu/')}`}
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 bg-white/5 hover:bg-white/10 text-gray-300 hover:text-white px-4 py-2 rounded-lg text-sm transition-colors"
            >
