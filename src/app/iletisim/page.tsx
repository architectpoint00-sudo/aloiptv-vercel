      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-20 sm:pt-12 sm:pb-28">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
          <a
            ...
            className="group card p-8 hover:border-green-500/20"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group card p-8 hover:border-blue-500/20"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-16">
          {[
            ...
            <div key={info.title} className="card p-6 text-center">
              ...
              <p className="text-[#555] text-xs">{info.value}</p>
            </div>
          ))}
        </div>

        {/* Bayilik */}
        <div className="bg-[#0d0d0d] border border-[#1a1a1a] rounded-2xl p-8 sm:p-12 text-center">
          <h2 className="text-2xl font-bold text-white mb-4">Bayilik Basvurusu</h2>
