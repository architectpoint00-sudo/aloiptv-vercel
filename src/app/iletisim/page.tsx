      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-12 sm:pt-12 sm:pb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12 sm:mb-16">
          <a
            ...
            className="group bg-[#111827] border border-[#1e293b] rounded-2xl p-8 hover:border-green-500/30 transition-all hover:-translate-y-1"
          >
            ...
            <p className="text-green-400 font-semibold text-base group-hover:underline">+1 (718) 586-4134</p>
          </a>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group bg-[#111827] border border-[#1e293b] rounded-2xl p-8 hover:border-blue-500/30 transition-all hover:-translate-y-1"
          >
            ...
            <p className="text-blue-400 font-semibold text-base group-hover:underline">@aloiptv</p>
          </a>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 mb-12 sm:mb-16">
          {[
            ...
            <div key={info.title} className="bg-[#111827] border border-[#1e293b] rounded-2xl p-6 text-center">
        ...
        {/* Bayilik */}
        <div className="bg-[#111827] border border-[#1e293b] rounded-2xl p-8 sm:p-12 text-center mb-12 sm:mb-16">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2.5 bg-red-500 hover:bg-red-600 text-white font-bold text-base px-8 py-4 rounded-full transition-all hover:scale-105 shadow-lg shadow-red-500/20"
          >
