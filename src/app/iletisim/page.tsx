      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-12 sm:pt-12 sm:pb-16">
        ...
        <div className="text-center mb-12 sm:mb-16">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black text-white mb-4 tracking-tight">
            Bizimle <span className="text-gradient">Iletisime</span> Gecin
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12 sm:mb-16">
          ...
          <a
            ...
            className="group glass-card rounded-2xl p-8 hover:border-green-500/20 transition-all duration-300 hover:-translate-y-1"
          >
            <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-green-500/10 to-green-500/5 border border-green-500/15 flex items-center justify-center mb-5">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group glass-card rounded-2xl p-8 hover:border-blue-500/20 transition-all duration-300 hover:-translate-y-1"
          >
            <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-blue-500/10 to-blue-500/5 border border-blue-500/15 flex items-center justify-center mb-5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 mb-12 sm:mb-16">
          <div className="glass-card rounded-2xl p-6 text-center">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-red-500/10 to-red-500/5 border border-red-500/15 flex items-center justify-center mx-auto mb-4">
              <svg className="w-6 h-6 text-red-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
            </div>
            <h3 className="text-white font-semibold mb-1">Calisma Saatleri</h3>
            <p className="text-gray-500 text-sm">7/24 Kesintisiz Destek</p>
          </div>
          ...
          <div className="glass-card rounded-2xl p-6 text-center">
            ...
            <p className="text-gray-500 text-sm">Ortalama 3 dakika</p>
          </div>
          ...
          <div className="glass-card rounded-2xl p-6 text-center">
            ...
            <p className="text-gray-500 text-sm">Turkce + Ingilizce</p>
          </div>
        </div>

        {/* Bayilik Section */}
        <div className="glass-card rounded-2xl p-8 sm:p-12 text-center mb-12 sm:mb-16">
          <h2 className="text-2xl sm:text-3xl font-black text-white mb-4 tracking-tight">
            Bayilik <span className="text-gradient">Basvurusu</span>
          </h2>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2.5 bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white font-bold text-base px-8 py-4 rounded-xl transition-all hover:scale-105 shadow-xl shadow-red-500/25 btn-shine"
          >
