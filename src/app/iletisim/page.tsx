      ...
      <section className="pt-28 sm:pt-36 pb-20">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-14">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white mb-4">Bizimle Iletisime Gecin</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-16">
            <a
              ...
              className="group rounded-2xl border border-white/10 bg-[#111827] p-6 sm:p-8 hover:border-[#25D366]/30 transition-all"
            >
              ...
              <p className="text-[#25D366] font-medium text-sm group-hover:underline">+1 (718) 586-4134</p>
            </a>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group rounded-2xl border border-white/10 bg-[#111827] p-6 sm:p-8 hover:border-blue-500/30 transition-all"
            >
          ...
          <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-[#111827] via-[#0d0d14] to-[#111827] p-10 sm:p-14 text-center">
            ...
            <div className="relative z-10">
              <h2 className="text-2xl sm:text-3xl font-extrabold text-white mb-4">Bayilik Basvurusu</h2>
